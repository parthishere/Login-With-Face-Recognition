...
class CityCollegeModel(models.Model):
    ...
    def __str__(self):
        return self.district.district_name + "> " + self.city_name + " " + str(self.pk)
...
class CollegeModel(models.Model):
    ...
    def __str__(self):
        return self.city.district.district_name + "> " + self.city.city_name + "> " + self.college_name + " " + str(self.pk)
...
class CollegeBranchModel(models.Model):
    ...
    def __str__(self):
        return self.college.college_name + "> " + self.branch_name + " " + str(self.pk)
