...
urlpatterns = [
    ...
    path("ajax/college/", load_colleges, name="college-data-url"),
    path("ajax/branch/", load_branches, name="branch-data-url"),
    ...
    path('profile/image/<int:pk>/update',
         update_profile_image_view, name='update-img-profile'),
    ...
    path('export-attendance-lec/<int:pk>/download',
         export_users_xls_lecture, name='export-lec'),
    path('export-attendance-ses/<int:pk>/download',
         export_users_xls_session, name='export-ses'),
    path("succsess/", succsess, name="sus"),
    path('profile/<int:pk>/attended-lectures',
         lecture_details, name="stud-lectures"),
