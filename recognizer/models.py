...
class UserProfile(models.Model):
    ...
    image = models.ImageField(upload_to=user_image_path, null=True, blank=True, max_length=500, help_text ="You cant fill this image again so be careful, or you can contact your teacher to change image")
    about = models.CharField(max_length=30, null=True, blank=True)
    gender = models.CharField(choices=GENDER_CHOICES, max_length=2,help_text ="You cant fill this gender again so be careful, or you can contact your teacher to change gender")
    ...
    college = models.ForeignKey(CollegeModel, on_delete=models.CASCADE, null=True, blank=True, help_text ="You cant fill this text again so be careful, or you can contact your teacher to change text")
    branch = models.ForeignKey(CollegeBranchModel, on_delete=models.CASCADE, null=True, blank=True, help_text ="You cant fill this text again so be careful, or you can contact your teacher to change text")
